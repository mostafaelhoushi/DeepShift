...
__all__ = ['preresnet20', 'preresnet56', 'preresnet110', 'preresnet164']
...
def preresnet20():
    return preresnet(depth=20)

def preresnet56():
    return preresnet(depth=56)

def preresnet110():
    return preresnet(depth=110)

def preresnet164():
    return preresnet(depth=164)